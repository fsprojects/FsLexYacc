...
[<assembly: AssemblyVersionAttribute("9.1.0")>]
[<assembly: AssemblyFileVersionAttribute("9.1.0")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "9.1.0"
    let [<Literal>] AssemblyFileVersion = "9.1.0"
