...
type LexBuffer<'char> =
    ...
    static member FromBytes: byte array -> LexBuffer<byte>

    /// Create a lex buffer suitable for Unicode lexing that reads characters from the given array
    static member FromChars: char array -> LexBuffer<char>
    ...
    static member FromFunction: ('char array * int * int -> int) -> LexBuffer<'char>

    /// Create a lex buffer that asynchronously reads character or byte inputs by using the given function
    static member FromAsyncFunction: ('char array * int * int -> Async<int>) -> LexBuffer<'char>

    [<System.Obsolete("Use LexBuffer<char>.FromFunction instead")>]
    static member FromCharFunction: (char array -> int -> int) -> LexBuffer<char>

    [<System.Obsolete("Use LexBuffer<byte>.FromFunction instead")>]
    static member FromByteFunction: (byte array -> int -> int) -> LexBuffer<byte>
...
[<Sealed>]
type AsciiTables =
    static member Create: uint16 array array * uint16 array -> AsciiTables
...
type UnicodeTables =
    ...
    static member Create: uint16 array array * uint16 array -> UnicodeTables
