...
["../../src/FsLexYacc.Runtime/bin/Release/netstandard2.0/FsLexYacc.Runtime.dll"
 "../../src/FsLex/bin/Release/netstandard2.0/FSharp.Core.dll"]
|> FileHelper.CopyTo "./"
...
let fsLex  = run "../../src/FsLex/bin/Release/netcoreapp3.1/fslex.exe"
let fsYacc = run "../../src/FsYacc/bin/Release/netcoreapp3.1/fsyacc.exe"
